...
<div class="body">
	...
	<div class="util">
		<form id="uploadForm" method="post" enctype="multipart/form-data">
			...
			<a href="#addDir" data-toggle="modal" role="button">
				<i class="icon-hdd"></i>新建目录
			</a>
			<a id="showRemovePage">
				<i class="icon-move"></i>移动
			</a>
			<a id="showCpPage">
				<i class="icon-briefcase"></i>复制
			</a>
	...
	<div class="navigation">
		<div class="nav_btns ele">
			<a href="fs/showUpFileSystem.do?appID=${result.appID}&id=${result.parentId}&fileIsHidden=0&fileStatus=0&isFileNameDesc=0" class="mvLeft">
		...
		<div class="nav_select ele">
			<input id="search" type="text" name="search" value="" placeholder="搜索我的网盘"/>
		...
		<script type="text/javascript">
			$(function(){
				...
				$(".searchButton").click(function () {
					...
					var appID = $("#appID").val();
					var url="fs/search.do?appID="+appID+"&currentPath=/&parentPath=/&fullPath=/&fileIsHidden=0&fileStatus=0&isFileNameDesc=0&searchContent="+searchContent;
					window.location.href=url;
				})
			})
		</script>
					...
					<td>
						<c:if test="${fs.fileType == 0 }">
							...
							<span>
										...
										<a class="deleteButton" fsid="${fs.id }">
